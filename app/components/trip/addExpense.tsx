...
export function AddExpense({ tripId }: AddExpenseProps) {
    ...
    return(
        <>
            <button className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#createExpenseModal">
                <IconText icon="add" text="New expense" color="#fff" />
            </button>
            <CreateExpenseModal tripId={ tripId } categories={ categories } currencies={ currencies } />
        </>
    )
}